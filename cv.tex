  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Specialisation: Biophysics and molecular imaging, 7.8/10}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Used biochemical assays to help post-doc researcher start project}
        \resumeItem{Aim of the project: Elucidate the structure of complement immune system protein C1}
      \resumeItemListEnd
...
\section{Extracurriculars}
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Finished most exercises in "The chemistry math book."}
        \resumeItem{Finished the exercises and more of \href{http://www.cs.uu.nl/docs/vakken/b1li/exercises.html}{"Logica voor informatica."}}
