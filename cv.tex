...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Research Intern}{Nov 2019 -- Nov 2020}
      {Crystal and structural chemistry, Bert Janssen group}{Utrecht, Netherlands}
      \resumeItemListStart
        \resumeItem{Major Project}
    ...
    \resumeSubheading
      ...
      {Crystal and structural chemistry, Piet Gros group}{Utrecht, Netherlands}
      \resumeItemListStart
        \resumeItem{Bachelor end project}
...
\section{Extracurriculars}
    \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {International buddy}{Nov 2020 -- Jan 2021}
      ...
      \resumeSubheading
      {Self studying}{Sept 2019-- Present}
